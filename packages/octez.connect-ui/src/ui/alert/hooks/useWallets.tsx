...
const useWallets = (
  ...
  // Guard against falsy / id-less entries: building a Map from a list that can
  // contain `undefined` (or wallets without an id) throws "Iterator value
  // undefined is not an entry object" (#30).
